	...
	<div style="position:absolute; left: 25px; top: 0px; z-index: 0; width: 700px">
        ...
        <script>
			...
			echo '<p><font size="3"> <br /> <span style="font-family:Arial, Helvetica, sans-serif; font-size:24px; font-weight:bold; text-shadow:none; color:#000">  Sales Lead Retrieval </span><br />
					...
					<p><font size="3">
					<a href="https://landscapearchitect.com/vendor/index-vendor.php?action=manage&record=' . $company_id . '"><span style="text-shadow:none"><strong><strong><span style="color:#00F">Click Here</span> to Return to Your Vendor Profile & Lead Center</strong></a></span></font></p>
					<br /><hr /><div id="div1">';	
	...
	// Check connection
		if ($conn->connect_error) {
			die("Connection failed: " . $conn->connect_error);
				...
				$sql="SELECT * FROM `leads` WHERE `vendor_id` = '" . $company_id . "' AND Date = '" . $week2 . "'";
